...
},{"./lib/ReactPropTypesSecret":10,"fbjs/lib/emptyFunction":1,"fbjs/lib/invariant":3}],8:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"./checkPropTypes":6,"./lib/ReactPropTypesSecret":10,"_process":5,"fbjs/lib/emptyFunction":1,"fbjs/lib/invariant":3,"fbjs/lib/warning":4,"object-assign":11}],9:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"_process":5,"fbjs/lib/emptyFunction":1,"fbjs/lib/emptyObject":2,"fbjs/lib/invariant":3,"fbjs/lib/warning":4,"object-assign":15,"prop-types/checkPropTypes":6}],13:[function(require,module,exports){
/** @license React v16.3.2
...
},{"fbjs/lib/emptyFunction":1,"fbjs/lib/emptyObject":2,"fbjs/lib/invariant":3,"object-assign":15}],14:[function(require,module,exports){
(function (process){
'use strict';
 ...
 */
var SuggestibleInput = function SuggestibleInput(props, context) {
  ...
  var shouldComponentUpdate = function shouldComponentUpdate(nextProps, nextState) {
    return nextProps.value === '' || nextProps.value !== component.props.value || nextState.input !== component.state.input || nextState.recentlyChoseSuggestion !== component.state.recentlyChoseSuggestion;
  };
  ...
  var onChange = function onChange(e) {
    var inputValue = component.refs.inputField.value;
  ...
  var chooseSuggestion = function chooseSuggestion(e) {
  ...
  var clearIsDisabled = function clearIsDisabled() {
  ...
  var renderSuggestions = function renderSuggestions(input) {
    var clickHandler = component.chooseSuggestion;

    return matches(input, component.state.suggestions).map(distanceToQuery(input)).sort(byDistance).slice(0, component.props.maxSuggestions).map(function (suggestionWithDistance, i) {
  ...
  var render = function render() {
    ...
    if (!component.state.recentlyChoseSuggestion) {
      var suggestionsList = component.renderSuggestions(component.state.input);
...
},{"prop-types":9,"react":14}]},{},[16])

//# sourceMappingURL=suggestible-input.js.map
