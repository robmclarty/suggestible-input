...
/***/ function(module, exports, __webpack_require__) {
	...
	var SuggestibleInput = __webpack_require__(2);

	var suggestions = ['Lorem Ipsum', 'Sit Amet', 'Dolor Consectetur', 'Dipiscing Amet', 'Lorem Ipsum', 'Sit Amet', 'Dolor Consectetur', 'Dipiscing Amet'];

	React.render(React.createElement(SuggestibleInput, {
	  ...
	  renderSuggestions: function renderSuggestions(input) {
	    ...
	    return matches(input, this.props.suggestions).map(distanceToQuery(input)).sort(byDistance).slice(0, this.props.maxSuggestions).map(function (suggestion, i) {
	      return _react2['default'].createElement('li', {
	        ...
	        key: i,
	        'data-suggestion': suggestion.value }, suggestion.value);
	    });
	  },
	  ...
	  render: function render() {
	    ...
	    if (!this.state.recentlyChoseSuggestion) {
	      ...
	      if (suggestionsList.length > 0) {
	        suggestionsHtml = _react2['default'].createElement('div', null, _react2['default'].createElement('ul', { className: 'suggestible-input-suggestions' }, suggestionsList), _react2['default'].createElement('div', {
	          onClick: this.closeSuggestions,
	          className: 'suggestible-input-bg' }));
	      }
	    }

	    return _react2['default'].createElement('div', { className: 'suggestible-input' }, _react2['default'].createElement('input', {
	      type: 'text',
	      ...
	      placeholder: this.props.placeholder }), _react2['default'].createElement('button', {
	      className: this.renderSearchClearClass(),
	      onClick: this.clearInput }, 'x'), _react2['default'].createElement('br', null), suggestionsHtml);
	  }
	});
